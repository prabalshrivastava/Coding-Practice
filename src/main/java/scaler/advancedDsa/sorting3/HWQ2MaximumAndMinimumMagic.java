...
//    Answer is evident.
    public static void main(String[] args) {
        int[] input1A = {3, 11, -1, 5};
        System.out.println(Arrays.toString(new HWQ2MaximumAndMinimumMagic().solve(input1A)));
        int[] input2A = {2, 2};
        System.out.println(Arrays.toString(new HWQ2MaximumAndMinimumMagic().solve(input2A)));
    }
