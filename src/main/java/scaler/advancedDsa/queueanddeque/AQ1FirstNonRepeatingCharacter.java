...
public class AQ1FirstNonRepeatingCharacter {
    //    Problem Description
...
//            "abcabc" -   no non repeating character so '#'
    public static void main(String[] args) {
        String input1A = "abadbc";
        System.out.println(new AQ1FirstNonRepeatingCharacter().solve(input1A));
        String input2A = "abcabc";
        System.out.println(new AQ1FirstNonRepeatingCharacter().solve(input2A));
    }
