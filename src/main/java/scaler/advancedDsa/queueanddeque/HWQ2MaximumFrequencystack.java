...
public class HWQ2MaximumFrequencystack {
    //    Problem Description
...
//    Just simulate given operations.
    public static void main(String[] args) {
        int[][] input1A = {
                ...
                {2, 0},
                {2, 0}};
        System.out.println(Arrays.toString(new HWQ2MaximumFrequencystack().solve(input1A)));

        int[][] input2A = {
                {1, 5},
                {2, 0},
                {1, 4}};
        System.out.println(Arrays.toString(new HWQ2MaximumFrequencystack().solve(input2A)));
    }
