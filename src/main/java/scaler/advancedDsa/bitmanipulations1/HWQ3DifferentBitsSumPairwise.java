...
public class HWQ3DifferentBitsSumPairwise {
    //    Problem Description
...
//    f(2, 2) + f(2, 3) + f(3, 2) + f(3, 3) = 0 + 1 + 1 + 0 = 2
    ...
    public static void main(String[] args) {
        int[] input1A = {1, 3, 5};
        System.out.println(new HWQ3DifferentBitsSumPairwise().cntBits(input1A));
        int[] input2A = {2, 3};
        System.out.println(new HWQ3DifferentBitsSumPairwise().cntBits(input2A));
    }
}
