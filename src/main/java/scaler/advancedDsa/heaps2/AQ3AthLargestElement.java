...
public class AQ3AthLargestElement {
//  Problem Description
...
//  So, output array is [-1, 15, 20, 20].
  ...
  public static void main(String[] args) {
    int input1A = 4;
    int[] input1B = {1, 2, 3, 4, 5, 6};
    System.out.println(Arrays.toString(new AQ3AthLargestElement().solve(input1A, input1B)));
    int input2A = 2;
    int[] input2B = {15, 20, 99, 1};
    System.out.println(Arrays.toString(new AQ3AthLargestElement().solve(input2A, input2B)));
  }
