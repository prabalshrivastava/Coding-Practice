...
public class AQ2EqualTreePartition {
    //    Problem Description
...
//    The given Tree cannot be partitioned.
    public static void main(String[] args) {
        ...
        System.out.println(new AQ2EqualTreePartition().solve(TreeUtils.mapArrayToTree(input1A)) + "\n---------------------------------");

        int[] input2A = {1, 2, 10, 20, 2};
        System.out.println(new AQ2EqualTreePartition().solve(TreeUtils.mapArrayToTree(input2A)) + "\n---------------------------------");

        int[] input3A = {11, 504, 742, 878, 148, -1, -1, -1, 392, -1, -1, -1};
        System.out.println(new AQ2EqualTreePartition().solve(TreeUtils.mapArrayToTree(input3A)) + "\n---------------------------------");
