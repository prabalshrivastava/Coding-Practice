...
//    There is no path which has sum -1.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new AQ2PathSum().hasPathSum(TreeUtils.mapArrayToTree(input1A), -1));

        int[] input2A = {5, 4, 8, 11, -1, 13, 4, 7, 2, -1, -1, -1, 1};
        System.out.println(new AQ2PathSum().hasPathSum(TreeUtils.mapArrayToTree(input2A), 22));
    }
}
