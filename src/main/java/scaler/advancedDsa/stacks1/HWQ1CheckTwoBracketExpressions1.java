...
public class HWQ1CheckTwoBracketExpressions1 {
    //    Problem Description
...
//        System.out.println(new HWQ1CheckTwoBracketExpressions().solve(input2A, input2B));//0
        ...
        System.out.println(new HWQ1CheckTwoBracketExpressions1().solve(input3A, input3B));//1

        String input4A = "(a+b-c-d+e-f+g+h+i)";
        String input4B = "a+b-c-d+e-f+g+h+i";
        System.out.println(new HWQ1CheckTwoBracketExpressions1().solve(input4A, input4B));//1

        String input5A = "(a+b-c-d+e-f+g+h+i)";
        String input5B = "a+b-c-d+e-f+g+h+i";
        System.out.println(new HWQ1CheckTwoBracketExpressions1().solve(input5A, input5B));//1
