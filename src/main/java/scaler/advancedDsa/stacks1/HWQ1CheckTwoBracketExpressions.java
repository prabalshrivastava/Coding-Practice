...
//    Both the expression are different.
    public static void main(String[] args) {
        ...
        System.out.println(new HWQ1CheckTwoBracketExpressions().solve(input1A, input1B));
        String input2A = "a-b-(c-d)";
        String input2B = "a-b-c-d";
        System.out.println(new HWQ1CheckTwoBracketExpressions().solve(input2A, input2B));
    }
