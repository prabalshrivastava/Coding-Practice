...
public class HWQ1SmallestPrefixString {
    //    Problem Description
...
//    The lexicographically smallest string will be "ab".
    public static void main(String[] args) {
        String input1A = "abba";
        String input1B = "cdd";
        System.out.println(new HWQ1SmallestPrefixString().smallestPrefix(input1A, input1B));
        String input2A = "acd";
        String input2B = "bay";
        System.out.println(new HWQ1SmallestPrefixString().smallestPrefix(input2A, input2B));
    }
