...
public class AQ1CyclicPermutations {
    //    Problem Description
...
//    All cyclic shifts of B are same as A and give 0 when taken xor with A. So, the ans is 3.
    public static void main(String[] args) {
        String input1A = "1001";
        String input1B = "0011";
        System.out.println(new AQ1CyclicPermutations().solve(input1A, input1B));
        String input2A = "111";
        String input2B = "111";
        System.out.println(new AQ1CyclicPermutations().solve(input2A, input2B));
    }
