...
public class HWQ2ClosestPalindrome {
    //    Problem Description
...
//    To make the string palindromic we need to change 2 characters.
    public static void main(String[] args) {
        String input1A = "abbba";
        System.out.println(new HWQ2ClosestPalindrome().solve(input1A));
        String input2A = "adaddb";
        System.out.println(new HWQ2ClosestPalindrome().solve(input2A));
    }
