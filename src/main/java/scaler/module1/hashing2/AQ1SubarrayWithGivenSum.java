...
//                System.out.printf("%s %s %n", start, end);
    ...
    public static void main(String[] args) {
        ...
        int input1B = 5;
        System.out.println(Arrays.toString(new AQ1SubarrayWithGivenSum().solve1(input1A, input1B)));

        int[] input2A = {5, 10, 20, 100, 105};
        int input2B = 110;
        System.out.println(Arrays.toString(new AQ1SubarrayWithGivenSum().solve1(input2A, input2B)));
        ...
        int input3B = 100;
        System.out.println(Arrays.toString(new AQ1SubarrayWithGivenSum().solve1(input3A, input3B)));
    }
}
